...
// first it will do the math in the parenthesis, mpg times fuelLeft
// we then compere that to distanceToPump
// if distanceToPump is greater then the parenthesis then its true
// if its less then its false
